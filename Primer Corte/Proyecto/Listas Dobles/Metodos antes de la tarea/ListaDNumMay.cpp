...
void letrero(){
	...
	cout<<"Este programa tiene como fin, mostrar el numero mayor de la lista doblemente en lazada "<<endl;//Escriba la descripcion aqui
}
void finDelPrograma(){
	cout<<"*---------------------------------------*"<<endl;
...
int menu(int opt){
	cout<<"Escoja una opcion\n 1)Mostrar el numero mayor de la lista \n 2)Mostrar Lista\n 3)Salir del programa\n->";
	cin>>opt;
	return opt;
}
int main(){

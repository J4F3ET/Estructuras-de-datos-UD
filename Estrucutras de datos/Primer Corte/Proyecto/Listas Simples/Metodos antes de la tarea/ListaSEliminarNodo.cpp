...
int ListaS::eliminar(ListaS *&cab,int dato){
	ListaS *aux1,*aux;
...
void letrero(){
	...
	cout<<"Este programa tiene como fin, de eliminar un nodo de la lista "<<endl;//Escriba la descripcion aqui
}
void finDelPrograma(){
	cout<<"*---------------------------------------*"<<endl;
...
int menu(int opt){
	cout<<"Escoja una opcion\n 1)Eliminar un nodo de la lista \n 2)Mostrar Lista\n 3)Salir del programa\n->";
	cin>>opt;
	return opt;
}
int main(){

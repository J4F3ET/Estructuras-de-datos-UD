...
void ListaD::mostraranterior(ListaD *cab){
    ListaD *aux=cab;
    while(aux->sig){
        aux=aux->sig;
    }
...
void letrero(){
	...
	cout<<"Este programa tiene como fin, mostrar la parte anterior sucesivamente \n(mostrar la lista alrevez) "<<endl;//Escriba la descripcion aqui
}
void finDelPrograma(){
	cout<<"*---------------------------------------*"<<endl;

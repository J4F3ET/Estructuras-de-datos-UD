...
void letrero(){
	...
	cout<<"Este programa tiene como fin mostrar la sumatoria de los nodos de la lista "<<endl;//Escriba la descripcion aqui
}
void finDelPrograma(){
	cout<<"*---------------------------------------*"<<endl;
